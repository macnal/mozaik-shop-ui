...
import {KoszykPageCart} from "@/app/koszyk2/KoszykPageCart";
import ky from "ky";
import {WeblinkerCart} from "@/api/gen/model";
import {useCart} from "@/context/cartProvider";
import {useNotification} from "@/context/notification";
import {KoszykPageCustomerAndDelivery} from "@/app/koszyk2/KoszykPageCustomerAndDelivery";
import {FormContainer} from 'react-hook-form-mui'
import {formArgs} from '@/app/koszyk2/formArgs'
...
export const KoszykPageClient = (props: KoszykPageClientProps) => {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                const data = await ky<WeblinkerCart>(`/api/cart2`, {}).json();
